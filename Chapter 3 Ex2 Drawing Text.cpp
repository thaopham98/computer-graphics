...
void drawScene(void)
{
	...
	glPushMatrix();
    // the next 3 lines determine the size, location and orientation of the text on the screen. Since stroke is not fix image
...
//cd /Applications/Studying/FA21/CSCI_4550
//g++ -framework OpenGL -lGLUT -lGLEW -I /opt/X11/include -L /opt/X11/lib -w -o out Chapter\ 3\ Ex2\ Drawing\ Text.cpp
